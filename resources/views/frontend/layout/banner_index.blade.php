        ...
        {{--<div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('images/home_slider_1.jpg') }}" class="d-block w-100" alt="Ảnh 1">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/home_slider_1.jpg') }}" class="d-block w-100" alt="Ảnh 2">
                </div>
                <div class="carousel-item">
                    <img src="{{ asset('images/home_slider_1.jpg') }}" class="d-block w-100" alt="Ảnh 3">
                </div>
            </div>
                ...
                <div class="owl-item">
                    ...
                    <div class="home_content_container">
                        <div class="home_content">
                            ...
                            <div class="button button_1 home_button trans_200"><a href="#">Shop NOW!</a></div>
                        </div>
                    </div>
                </div>
